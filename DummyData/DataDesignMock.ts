...
export const dataDesignMock: FilterCardType = [
  {
    "web-design": [
      ...
      {
        url: "/assets/web-design/desktop/image-photon.jpg",
        title: "PHOTON",
        description:
          "A state-of-the-art music player with high-resolution audio and DSP effects",
      },
      {
        url: "/assets/web-design/desktop/image-builder.jpg",
        title: "BUILDER",
        description:
          "Connects users with local contractors based on their location",
      },
      {
        url: "/assets/web-design/desktop/image-blogr.jpg",
        title: "BLOGR",
        description:
          "Blogr is a platform for creating an online blog or publication",
      },
      {
        url: "/assets/web-design/desktop/image-camp.jpg",
        title: "CAMP",
        description:
...

  {
    "app-design": [
      ...
      {
        url: "/assets/app-design/desktop/image-faceit.jpg",
        title: "FACEIT",
        description:
          "Get to meet your favorite internet superstar with the faceit app",
      },
      {
        url: "/assets/app-design/desktop/image-todo.jpg",
        title: "TODO",
        description:
          "A todo app that features cloud sync with light and dark mode",
      },
      {
        url: "/assets/app-design/desktop/image-loopstudios.jpg",
        title: "LOOPSTUDIOS",
...

  {
    "graphic-design": [
      ...
      {
        url: "/assets/graphic-design/desktop/image-science.jpg",
        title: "SCIENCE!",
        description:
